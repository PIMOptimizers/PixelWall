...
image = pygame.image.load(r'./TetrisResources/Down Rotate Left Right.png')
...
# test whether the falling shape is in a valid space
...
# check whether the user have lost
